...
const PRODUCT_REDIRECTS = [
  ...
  ["baklja-za-rostilj", "/oprema?cat=rostilj-kuhanje"],
  ["peka-sac", "/oprema?cat=rostilj-kuhanje"],
  ...
  ["velika-jenga", "/oprema?cat=oprema-za-evente"],
  ["cornhole", "/oprema?cat=oprema-za-evente"],
  ["projektor-sa-platnom", "/najam/projektor-s-platnom-najam"],
  ["paviljon-sator-3x3m", "/najam/paviljon-sator-3x3m-najam"],
  ["prenosivi-stol-i-2-klupe-za-8-osoba", "/oprema?cat=oprema-za-evente"],
  ["beerpong-stol", "/oprema?cat=oprema-za-evente"],
  ...
  ["jbl-bezicni-mikrofoni", "/oprema?cat=audio-video-oprema"],
  ["dji-neo-dron", "/oprema?cat=audio-video-oprema"],
  ["stalak-za-kolace", "/oprema?cat=oprema-za-evente"],
  ["fujifilm-instax-mini-evo", "/oprema?cat=audio-video-oprema"],
];
